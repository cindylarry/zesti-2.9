; ModuleID = '/home/klee/zesti-2.9/runtime/klee-libc/__cxa_atexit.c'
...
@.str1 = private unnamed_addr constant [54 x i8] c"/home/klee/zesti-2.9/runtime/klee-libc/__cxa_atexit.c\00", align 8
...
bb:                                               ; preds = %entry
  tail call void @klee_report_error(i8* getelementptr inbounds ([54 x i8]* @.str1, i64 0, i64 0), i32 39, i8* getelementptr inbounds ([32 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str3, i64 0, i64 0)) noreturn nounwind, !dbg !35
  unreachable, !dbg !35
...
!1 = metadata !{i32 589865, metadata !"__cxa_atexit.c", metadata !"/home/klee/zesti-2.9/runtime/klee-libc", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"__cxa_atexit.c", metadata !"/home/klee/zesti-2.9/runtime/klee-libc", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 true, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
